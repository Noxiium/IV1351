...
addresses_id INT GENERATED ALWAYS AS IDENTITY NOT NULL,
street_name VARCHAR(100) NOT NULL,
city_name VARCHAR(50) NOT NULL,
zip_code VARCHAR(5) NOT NULL
);

ALTER TABLE addresses ADD CONSTRAINT PK_addresses PRIMARY KEY (addresses_id);
...
-- Foreign keys
ALTER TABLE contact_details ADD CONSTRAINT FK_contact_details_0 FOREIGN KEY (addresses_id) REFERENCES addresses (addresses_id);
...
ALTER TABLE group_lesson ADD CONSTRAINT FK_group_lesson_0 FOREIGN KEY (time_slot_id) REFERENCES time_slot (time_slot_id);
...
ALTER TABLE group_lesson ADD CONSTRAINT FK_group_lesson_3 FOREIGN KEY (instrument_type_id) REFERENCES instrument_type (instrument_type_id);

ALTER TABLE individual_lesson ADD CONSTRAINT FK_individual_lesson_0 FOREIGN KEY (time_slot_id) REFERENCES time_slot (time_slot_id);
...
ALTER TABLE individual_lesson ADD CONSTRAINT FK_individual_lesson_3 FOREIGN KEY (instrument_type_id) REFERENCES instrument_type (instrument_type_id);
